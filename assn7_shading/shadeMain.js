...
function setUpCamera(program) {
  ...
  glMatrix.mat4.perspective(proj, radians(30), 1, 1, 100);
...
function drawShapes(object, program) {
  ...
  function init() {
    ...
    console.log(gl.getFragDataLocation(perVertexProgram, 'ka'));
	console.log(gl.getFragDataLocation(perFragmentProgram, 'ka'));
    // do a draw
    draw();
  }
